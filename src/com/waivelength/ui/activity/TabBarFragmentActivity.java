...
import com.waivelength.ui.fragment.NewsfeedFragment;
import com.waivelength.ui.fragment.NotificationFragment;
import com.waivelength.ui.fragment.ProfileFragment;
import com.waivelength.ui.fragment.SettingsFragment;
import com.waivelength.ui.fragment.TermsFragment;
import com.waivelength.ui.fragment.UserinfoFragment;
...
public class TabBarFragmentActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		mNewsfeedButton.setBackground(getDrawable(R.drawable.newsfeed_pressed));
    ...
    public void goToTab(int whichtab){
    	...
    	case FRAGMENT_NEWSFEED:
			...
			mNewsfeedButton.setBackground(getDrawable(R.drawable.newsfeed_pressed));
			mNotificationButton.setBackground(getDrawable(R.drawable.notification));
			mProfileButton.setBackground(getDrawable(R.drawable.profile));
			mSettingsButton.setBackground(getDrawable(R.drawable.settings_disable));	
    	...
    	case FRAGMENT_NOTIFICATION:
			...
			mNewsfeedButton.setBackground(getDrawable(R.drawable.newsfeed));
			mNotificationButton.setBackground(getDrawable(R.drawable.notification_presed));
			mProfileButton.setBackground(getDrawable(R.drawable.profile));
			mSettingsButton.setBackground(getDrawable(R.drawable.settings_disable));	
    	...
    	case FRAGMENT_PROFIEL:
			...
			mNewsfeedButton.setBackground(getDrawable(R.drawable.newsfeed));
			mNotificationButton.setBackground(getDrawable(R.drawable.notification));
			mProfileButton.setBackground(getDrawable(R.drawable.profile_pressed));
			mSettingsButton.setBackground(getDrawable(R.drawable.settings_disable));	
    	...
    	case FRAGMENT_SETTINGS:
			...
			mNotificationButton.setBackground(getDrawable(R.drawable.notification));
			mProfileButton.setBackground(getDrawable(R.drawable.profile));
			mSettingsButton.setBackground(getDrawable(R.drawable.settings_pressed));	
